    ...
    <div class="Container Wide">
        ...
        <div class="Overview">
            ...
            <form action="addAdmin.php" method="POST">
                ...
                <p><input type="submit" value="Add" name="addAdmin" />
            </form>
            ...
            <?php
                if(isset($_POST['addAdmin'])){
                    ...
                    $loc = $_POST['location'];
                   $exSQL = "SELECT * FROM `admins` WHERE `user_email` = '$email' AND `user_password` = '$pswd'";
                    
                    if(mysqli_num_rows(mysqli_query($conn, $exSQL)) >= 1){
                        echo "<font color='red'> User already exists.</font>";
                       
                    }else{
                        $inSQL = "INSERT INTO `admins`(`user_email`, `fname`, `user_password`, `location`) VALUES ('$email','$fname','$pswd','$loc')";
